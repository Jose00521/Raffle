...
const foundTitles = [
  ...
  { number: '001003', name: 'Maria Oliveira', value: 2000, date: '05/07/2025', category: 'diamante' },
  { number: '001008', name: 'Pedro Santos', value: 2000, date: '05/07/2025', category: 'diamante' },
  
  // Examples from Master category (using actual numbers from fixedPrizes)
  { number: '001103', name: 'João Silva', value: 1000, date: '07/07/2025', category: 'master' },
  { number: '001107', name: 'Ana Ferreira', value: 1000, date: '08/07/2025', category: 'master' },
  
  // Examples from Premiado category (using actual numbers from fixedPrizes)
  { number: '001203', name: 'Carlos Souza', value: 500, date: '06/07/2025', category: 'premiado' },
  { number: '001210', name: 'Fernanda Costa', value: 500, date: '05/07/2025', category: 'premiado' },
];
