...
const RaffleFormFieldsUpdateOptimized: React.FC<RaffleFormFieldsUpdateOptimizedProps> = ({
  ...
  const processedInitialData = useMemo(() => {
    ...
    return {
      ...
      isScheduled: Boolean(initialData.scheduledActivationDate && new Date(initialData.scheduledActivationDate).toISOString() > new Date().toISOString()),
      ...
      enablePackages: initialData.numberPackages && initialData.numberPackages.length > 0 || false,
